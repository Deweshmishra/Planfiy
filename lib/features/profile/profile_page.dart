                ...
                children: [
                  ...
                  ValueListenableBuilder(
                    ...
                    builder: (context, userBox, _) {
                      ...
                      String name = userBox.get("name") ?? "User";
                      String email = userBox.get("email") ?? "No Email";
        ...
        return Container(
          ...
          child: Row(
            ...
            children: [
              ...
              buildStatItem("Tasks", "$totalTasks"),
              buildStatItem("Done", "$completedTasks"),
              buildStatItem("Score", "$score%"),
